...
class _AsyncClientAdapter:
    ...
    **INTERNAL**
    ...
    async def update_credential(self, new_credential: Credential) -> None:
        ...
        # is baked into the httpx AsyncClient, so rebuild both. Outstanding streaming
        # responses keep a reference to the old Client and continue to completion; new
        # requests use the new Client.
