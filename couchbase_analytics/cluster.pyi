...
class Cluster:
    ...
    @overload
    @classmethod
    def create_instance(cls, endpoint: str, credential: AnyCredential) -> Cluster: ...
    @overload
    @classmethod
    def create_instance(cls, endpoint: str, credential: AnyCredential, options: ClusterOptions) -> Cluster: ...
    @overload
    @classmethod
    def create_instance(
