...
class Cluster:
    @overload
    def __init__(self, http_endpoint: str, credential: AnyCredential) -> None: ...
    @overload
    def __init__(self, http_endpoint: str, credential: AnyCredential, options: ClusterOptions) -> None: ...
    @overload
    def __init__(self, http_endpoint: str, credential: AnyCredential, **kwargs: Unpack[ClusterOptionsKwargs]) -> None: ...
    @overload
    def __init__(
        self,
        http_endpoint: str,
    ...
    @overload
    @classmethod
    def create_instance(cls, http_endpoint: str, credential: AnyCredential) -> Cluster: ...
    @overload
    @classmethod
    def create_instance(cls, http_endpoint: str, credential: AnyCredential, options: ClusterOptions) -> Cluster: ...
    @overload
    @classmethod
    def create_instance(
        cls, http_endpoint: str, credential: AnyCredential, **kwargs: Unpack[ClusterOptionsKwargs]
    ) -> Cluster: ...
    @overload
    @classmethod
    def create_instance(
        cls, http_endpoint: str, credential: AnyCredential, options: ClusterOptions, **kwargs: Unpack[ClusterOptionsKwargs]
    ) -> Cluster: ...
